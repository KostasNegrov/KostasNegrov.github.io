...
Один из способов моего обучения является взять готовый html шаблон и реализовать верстку так как это сделал-бы я. Проект Dovaina является одним из таких. В этом проекте меня заинтересовало воспроизвести первый экран, что мною и было успешно сделано. Здесь я изучил ка в Owl Carousel реализовать анимацию. <br><br>
